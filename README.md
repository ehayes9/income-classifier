...
As part of Udacity's Machine Learning Nanodegree, built a supervised learning model to determine whether an individual makes greater than \$65k per year (use case was for a charity organization to determine whether to contact an individual). 
...
Also analyzed features importance & selection.
